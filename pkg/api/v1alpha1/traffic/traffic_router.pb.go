...
//
// <!-- crd generation tags
// +cue-gen:TrafficRouterSpec:groupName:traffic.opensergo.io
// +cue-gen:TrafficRouterSpec:version:v1alpha1
// +cue-gen:TrafficRouterSpec:annotations:helm.sh/resource-policy=keep
// +cue-gen:TrafficRouterSpec:labels:app=istio-pilot,chart=istio,heritage=Tiller,release=istio
// +cue-gen:TrafficRouterSpec:subresource:status
// +cue-gen:TrafficRouterSpec:scope:Namespaced
// +cue-gen:TrafficRouterSpec:resource:categories=istio-io,networking-istio-io,shortNames=vs
// +cue-gen:TrafficRouterSpec:printerColumn:name=Gateways,type=string,JSONPath=.spec.gateways,description="The names of gateways and sidecars
// that should apply these routes"
// +cue-gen:TrafficRouterSpec:printerColumn:name=Hosts,type=string,JSONPath=.spec.hosts,description="The destination hosts to which traffic is being sent"
// +cue-gen:TrafficRouterSpec:printerColumn:name=Age,type=date,JSONPath=.metadata.creationTimestamp,description="CreationTimestamp is a timestamp
// representing the server time when this object was created. It is not guaranteed to be set in happens-before order across separate operations.
// Clients may not set this value. It is represented in RFC3339 form and is in UTC.
// Populated by the system. Read-only. Null for lists. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata"
// +cue-gen:TrafficRouterSpec:preserveUnknownFields:false
// -->
//
// <!-- go code generation tags
// +kubetype-gen
// +kubetype-gen:groupVersion=traffic.opensergo.io/v1alpha1
// +genclient
