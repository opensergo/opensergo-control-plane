...
// DeepCopyInto supports using VirtualServiceSpecSpec within kubernetes types, where deepcopy-gen is used.
func (in *VirtualServiceSpec) DeepCopyInto(out *VirtualServiceSpec) {
	p := proto.Clone(in).(*VirtualServiceSpec)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualServiceSpecSpec. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new VirtualServiceSpecSpec. Required by controller-gen.
func (in *VirtualServiceSpec) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
